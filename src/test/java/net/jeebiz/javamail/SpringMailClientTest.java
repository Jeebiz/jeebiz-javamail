...
import net.jeebiz.javamail.conf.EmailBody;
import net.jeebiz.javamail.def.SpringMailClientImpl;
import net.jeebiz.javamail.provider.EmailPropertiesProvider;
import net.jeebiz.javamail.provider.def.DefaultEmailPropertiesProvider;
...
public class SpringMailClientTest {
	...
	protected SpringMailClientImpl mailClient;
	...
	public void setup(){
		...
		mailClient = new SpringMailClientImpl();
		
		mailClient.setMailSender(new JavaMailSenderImpl());
